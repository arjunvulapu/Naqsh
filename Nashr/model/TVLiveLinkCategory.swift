//
//	TVLiveLinkCategory.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class TVLiveLinkCategory : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		tvs = [Tv]()
		if let tvsArray = dictionary["tvs"] as? [NSDictionary]{
			for dic in tvsArray{
				let value = Tv(fromDictionary: dic)
				tvs.append(value)
			}
		}
	}
	...
	func toDictionary() -> NSDictionary
	{
		...
		if tvs != nil{
			...
			for tvsElement in tvs {
				dictionaryElements.append(tvsElement.toDictionary())
			}
			dictionary["tvs"] = dictionaryElements
		}
		return dictionary
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         tvs = aDecoder.decodeObjectForKey("tvs") as? [Tv]
    ...
    */
    @objc func encodeWithCoder(aCoder: NSCoder)
	{
		...
		if tvs != nil{
			aCoder.encodeObject(tvs, forKey: "tvs")
		}
