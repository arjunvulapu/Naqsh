//
//  UrgentNewsItemDetailsTableViewCell.swift
//  Nashr
//
...
class UrgentNewsItemDetailsTableViewCell: UITableViewCell {
...
//            self.labelFullDate.text = formatter.stringFromDate(date2!)
//            
